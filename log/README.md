...
| Dungeon Master | [2026-08-07 03:39](https://github.com/sycosquirl18/agents-and-dragons/actions/runs/31145027752) | ok | 1 | — |
| Folk Caller | never | **never run** | 0 | — |
| Magician | never | **never run** | 0 | — |
| Quartermaster _(retired)_ | [2026-08-07 01:44](https://github.com/sycosquirl18/agents-and-dragons/actions/runs/31138999971) | ok | 1 | — |
| Recruiter | never | **never run** | 0 | — |
| Rules Smith | never | **never run** | 0 | — |
| World Designer | [2026-08-07 03:03](https://github.com/sycosquirl18/agents-and-dragons/actions/runs/31143179044) | ok | 2 | 1 |

## Recent trouble

- `2026-08-07 01:53` **World Designer** — failure · [run](https://github.com/sycosquirl18/agents-and-dragons/actions/runs/31139462176)
